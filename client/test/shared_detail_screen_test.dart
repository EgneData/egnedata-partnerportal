...
void main() {
  ...
  DirectoryRecordWrapper acmeDirectoryRecord() {
    final signedRecord =
  ...
  group('SharedDetailScreen happy path', () {
    testWidgets('decrypts and renders fixture plaintext', (tester) async {
      ...
      when(() => mockDir.getIssuerDirectory(any()))
          .thenAnswer((_) async => [acmeDirectoryRecord()]);

      await tester.pumpWidget(
          buildScreen(mockShared, mockDir, 'some-entry-id', session));
