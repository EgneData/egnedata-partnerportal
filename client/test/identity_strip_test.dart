...
void main() {
  ...
  group('IdentityStrip', () {
    ...
    testWidgets('renders handle and fingerprint for alice_enc key',
      ...
      await tester.pumpWidget(buildStrip(handle: 'alice', publicKey: pubKey));
    ...
    testWidgets('no display_name hides display_name row', (tester) async {
      ...
      await tester.pumpWidget(
          buildStrip(handle: 'bob', publicKey: pubKey, displayName: null));
      await tester.pumpAndSettle();
    ...
    testWidgets('fingerprint renders identically to Fingerprint.render()',
      ...
      await tester.pumpWidget(buildStrip(handle: 'acme', publicKey: pubKey));
      await tester.pumpAndSettle();
