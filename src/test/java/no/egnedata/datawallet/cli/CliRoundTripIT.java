...
import no.egnedata.datawallet.crypto.UuidV7;
import no.egnedata.datawallet.crypto.X25519;
import no.egnedata.datawallet.directory.DirectoryRecordCodec;
import no.egnedata.datawallet.directory.PinnedRoot;
import no.egnedata.datawallet.directory.RootUpdateCodec;
import no.egnedata.partnerportal.persistence.PostgresTestcontainer;
import no.egnedata.partnerportal.security.HeaderIssuerPrincipalResolver;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;
import org.springframework.beans.factory.annotation.Autowired;
import no.egnedata.partnerportal.PartnerPortalApplication;
...
@SpringBootTest(classes = PartnerPortalApplication.class)
...
class CliRoundTripIT {
    ...
    private static byte[] computeKeyId(byte[] publicKey) {
        return Arrays.copyOf(no.egnedata.datawallet.crypto.Sha256.hash(publicKey), 16);
    }
