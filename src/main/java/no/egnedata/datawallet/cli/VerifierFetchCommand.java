package no.egnedata.datawallet.cli;

import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import no.egnedata.partnerportal.api.auth.AuthController;
import no.egnedata.datawallet.crypto.Argon2id;
import no.egnedata.datawallet.crypto.CanonicalCborMapper;
import no.egnedata.datawallet.crypto.Ed25519;
import no.egnedata.datawallet.crypto.SealedBox;
import no.egnedata.datawallet.crypto.SecretBox;
import no.egnedata.datawallet.envelope.EnvelopeCodec;
import no.egnedata.datawallet.envelope.RecipientWrapping;
import no.egnedata.datawallet.envelope.SharedEnvelope;
...
public class VerifierFetchCommand implements Callable<Integer> {
    ...
    private static byte[] derivePublicFromSecret(byte[] secret) {
        ...
        int rc = no.egnedata.datawallet.crypto.CryptoProvider.sodium()
