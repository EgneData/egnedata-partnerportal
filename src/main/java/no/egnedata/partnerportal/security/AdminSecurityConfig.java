 ...
 * {@code partnerportal.security.admin-mtls=true} (the production default).
...
public class AdminSecurityConfig {
    ...
    public AdminSecurityConfig(@Value("${partnerportal.security.admin-ou:operators}") String adminOu) {
