...
import no.egnedata.datawallet.directory.RootQuorum;
import no.egnedata.datawallet.directory.RootUpdate;
import no.egnedata.datawallet.directory.RootUpdateCodec;
import no.egnedata.partnerportal.domain.PinnedRootHistoryEntity;
import no.egnedata.partnerportal.domain.PinnedRootHistoryRepository;
