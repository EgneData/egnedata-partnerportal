...
import no.egnedata.datawallet.intermediate.security.StubTriggerAuthResolver;
...
class AccountDeletionRevokeTriggerTest {
    ...
    void setUp() {
        ...
        PartnerPortalAdminClient client = new StubAdminClient(
                new PartnerPortalAdminClient.IssuerRecord(keyId, "active", activeRecord),
                publishCount);
    ...
    void returns404ForUnknownInstall() throws Exception {
        PartnerPortalAdminClient noRecordClient = new StubAdminClient(null, new AtomicInteger());
    ...
    private static class StubAdminClient extends PartnerPortalAdminClient {
        private final PartnerPortalAdminClient.IssuerRecord record;
        private final AtomicInteger publishCount;

        StubAdminClient(PartnerPortalAdminClient.IssuerRecord record, AtomicInteger publishCount) {
