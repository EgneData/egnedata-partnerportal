package no.egnedata.datawallet.intermediate.client;
...
public class PartnerPortalAdminClient {

    private static final Logger log = LoggerFactory.getLogger(PartnerPortalAdminClient.class);
    ...
    public PartnerPortalAdminClient(String serverBaseUrl) {
    ...
    protected PartnerPortalAdminClient(String serverBaseUrl, HttpClient httpClient) {
        this.serverBaseUrl = serverBaseUrl;
