...
Partner Portal is an end-to-end-encrypted, issuer-signed envelope delivery
...
[`security/IssuerPrincipalResolver.java`](../../src/main/java/no/egnedata/partnerportal/security/IssuerPrincipalResolver.java)
(interface) and
...
verifier role via
[`cli/VerifierFetchCommand.java`](../../src/main/java/no/egnedata/datawallet/cli/VerifierFetchCommand.java).
The server endpoint the verifier talks to is
[`api/verifier/VerifierController.java`](../../src/main/java/no/egnedata/partnerportal/api/verifier/VerifierController.java).
...
[`api/`](../../src/main/java/no/egnedata/partnerportal/api/).
...
[`directory/`](../../src/main/java/no/egnedata/datawallet/directory/);
