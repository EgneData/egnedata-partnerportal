...
[sdr]: ../../src/main/java/no/egnedata/datawallet/cli/SignDirectoryRecordCommand.java
[claude]: ../../CLAUDE.md
...
[adc]: ../../src/main/java/no/egnedata/partnerportal/api/admin/AdminDirectoryController.java
...
- [`IssuerSecurityConfig.java:22`][isc] — Spring Security chain at
  ...
  `partnerportal.security.issuer-mtls=true` (production default).
...
[isc]: ../../src/main/java/no/egnedata/partnerportal/security/IssuerSecurityConfig.java
[xres]: ../../src/main/java/no/egnedata/partnerportal/security/X509IssuerPrincipalResolver.java
