...
Glossary of terms used throughout the Partner Portal docs and code.
...
[ccm]: ../src/main/java/no/egnedata/datawallet/crypto/CanonicalCborMapper.java
...
In Partner Portal, this term appears around the **intermediate signing
...
1. **The application is an ordinary Spring Boot service.** It runs
   ...
   endpoints, talks to Postgres / the Partner Portal server / mobile
...
- It does **not** mean the HSM is a separate application you have
  ...
  via a stable API.
- It does **not** mean the Partner Portal server is HSM-backed. Only
  the intermediate is. The Partner Portal server (this repo) does no
...
[gen-root]: ../src/main/java/no/egnedata/datawallet/cli/GenRootCommand.java
[sd]: ../src/main/java/no/egnedata/datawallet/cli/SignDirectoryRecordCommand.java
[sru]: ../src/main/java/no/egnedata/datawallet/cli/SignRootUpdateCommand.java
[idt]: ../src/main/java/no/egnedata/datawallet/cli/InitDevTrustCommand.java
[plan]: specs/plan.md
